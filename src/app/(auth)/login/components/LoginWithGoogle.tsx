const LoginWithGoogle = () => {
    return (
        <div className="max-w-md mx-auto flex flex-row gap-4 justify-center">
            <button
            ...
            >
                <svg
                    ...
                    viewBox="0 0 24 24"
                >
                    <path fill="blue" d="M14.2 2.875A4.625 4.625 0 0 0 9.575 7.5v2.575H7.1c-.124 0-.225.1-.225.225v3.4c0 .124.1.225.225.225h2.475V20.9c0 .124.1.225.225.225h3.4c.124 0 .225-.1.225-.225v-6.975h2.497c.103 0 .193-.07.218-.17l.85-3.4a.225.225 0 0 0-.218-.28h-3.347V7.5a.775.775 0 0 1 .775-.775h2.6c.124 0 .225-.1.225-.225V3.1c0-.124-.1-.225-.225-.225z"></path>
                </svg>
            </button>
        </div>
    )
